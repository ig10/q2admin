...
//*** UPDATE START ***
	if(cmd[0] == '!')
	{
		...
		// QQ CLAN SERVER CONNECTION
		else if(Q_stricmp (cmd, "!publico1") == 0)
		{
			if(num_admins)
			{
				gi.cprintf(ent, PRINT_HIGH, "Connecting to Publico 1 - By QQ Team\n");
				stuffcmd(ent, "connect clanqq.com:27000");
			}
			return FALSE;
		}
		else if(Q_stricmp (cmd, "!liga1") == 0)
		{
			if(num_admins)
			{
				gi.cprintf(ent, PRINT_HIGH, "Connecting to Liga 1 - By QQ Team\n");
				stuffcmd(ent, "connect clanqq.com:28000");
			}
			return FALSE;
		}
		else if(Q_stricmp (cmd, "!liga2") == 0)
		{
			if(num_admins)
			{
				gi.cprintf(ent, PRINT_HIGH, "Connecting to Liga 2 - By QQ Team\n");
				stuffcmd(ent, "connect clanqq.com:29000");
			}
			return FALSE;
		}
		// END QQ CLAN SERVER CONNECTION
